...
public class BeanMappingExecutor {
     ...
     */
    private BatchExecutor getSetBatchExecutor(BeanMappingParam param, BeanMappingObject config) {
     ...
     */
    private BatchExecutor getGetBatchExecutor(BeanMappingParam param, BeanMappingObject config) {
     ...
     */
    private Class getSrcClass(GetExecutor getExecutor) {
